...
if (isset($_POST['submit'])) {
    ...
    $base_url       = "https://www.gopalanenterprises.com/bulk_email/referal/";

    // landing page urls for redirect
    $aqua           = "https://www.gopalanenterprises.com/bulk_email/referal/under_construction_apartments_in_bangalore/index.php";
    $lakefront      = "https://www.gopalanenterprises.com/bulk_email/referal/ready_to_move_flats_in_electronic_city_phase/index.php";
    $florenza       = "https://www.gopalanenterprises.com/bulk_email/referal/under_construction_apartments_in_banashankari/index.php";
    ...
    */ 
    ...
    foreach($clients_detail as $clients){
        ...
        $to         = $clients->email;
        $subject    = "Refer and Earn up to 50k | Gopalan Enterprises";
        $message    = '
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-left"style="color:#5d5c5c; font-family:\'Raleway\', Arial,sans-serif; font-size:14px; line-height:22px; text-align:left; padding-bottom:22px;"><div mc:edit="text_5">
                                                                            <ul style="list-style: none; margin: 0; padding: 0;">
                                                                                <li>Refer your friend and get a chance to win up to Rs. 1 Lac</li>
                                                                                <li>Rs. 1 Lac for Gopalan Olympia</li>
                                                                                <li>Rs. 1 Lac for Gopalan Sanskriti</li>
                                                                                <li>Rs. 50,000 for Gopalan Lakefront</li>
                                                                                <li>Rs. 50,000 for Gopalan Aqua</li>
                                                                                <li>Rs. 50,000 for Gopalan Florenza</li>
                                                                                <li>Spread the happiness!</li>
                                                                            </ul>
                                                                        </div></td>
                                                                    </tr>
                                                                </table>
