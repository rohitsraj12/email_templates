...
if (isset($_POST['submit'])) {
    ...
    $base_url       = "https://www.gopalanenterprises.com/bulk_email/olympia/";
    ...
    $olympia        = "https://www.gopalanenterprises.com/bulk_email/olympia/ready_to_move_flats_in_kumbalgodu_olympia_clients/index.html";
                                                                            ...
                                                                            <table border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td class="text-button-orange"style="color:#ffffff; font-family:\'Kreon\', \'Times New Roman\', Georgia, serif; font-size:14px; line-height:18px; text-align:center; ">
                                                                                        <div mc:edit="text_6">
                                                                                            <a class="link-white"style="background:#e85711; padding:10px 30px; border-radius:20px; color:#ffffff; text-decoration:none; display:block" href="'.  $olympia  . '?id=' . $to . "&name=" . $ref_name . "&phone=" . $ref_phone . '" target="_blank" class="link-white"style="color:#ffffff; text-decoration:none;">
